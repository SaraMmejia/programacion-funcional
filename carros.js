...
// “This <brand> from <model> costs $<price>” (e.g. for the first element it should say “This Mazda from 1989 costs $5241”).
...
//     return cars.filter( (c => c.brand === "Ferrari");
// }

// console.log(ferraris(list));


// function nineties(cars) {
//     return cars.filter ( c => c.model >= 1980 && c.model <= 1990 );
// }
// console.log(nineties(l));


// function list(arr) {
//     return nArr = arr.map( c => "This " + c.brand + " from " + c.model + " costs " + c.price );
// }
...
function bmwSum(a){
    let b = a.filter (c => c.brand === "BMW");

    b = b.map ( c => c.price)

    return b.reduce ( (acc,c ) => acc + c );
}

console.log(bmwSum(l));
